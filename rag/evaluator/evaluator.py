    ...
    def evaluate(self, data):
        ...
        for metric in self.metrics:
            try:
                ...
                # 由于 data 是单个 EvaluationData 实例，不需要迭代
                for metric_score, (pred, golden_answers) in zip(metric_scores, zip(data.pred, data.golden_answers)):
                    data.update_evaluation_score(metric, metric_score)
