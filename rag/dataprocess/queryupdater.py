...
def get_summary(text: str, llm_model: str):
    ...
    messages = [
        {
            "role": "system",
            "content": """The following text is a series of conversations between a user and a customs agent assistant. Please summarize the content of the conversation.
...
client = OpenAI(
    base_url="https://dashscope.aliyuncs.com/compatible-mode/v1", api_key="sk-c02056e042844ee1815cb64d8ede554f"
)
